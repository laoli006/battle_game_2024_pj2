...
KerryTank::KerryTank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void KerryTank::Update() {
  TankMove(3.0f, glm::radians(180.0f));
  TurretRotate();
  Fire();
}

void KerryTank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool KerryTank::IsHit(glm::vec2 position) const {
...
const char *KerryTank::UnitName() const {
  return "Kerry Tank";
}

const char *KerryTank::Author() const {
  return "KerryLi";
}
}  // namespace battle_game::unit
